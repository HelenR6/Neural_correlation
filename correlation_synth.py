...
#     ])
  ...
  with h5py.File(f'{model_type}_synth_layer_activation.hdf5','r')as s:
    with h5py.File(f'{model_type}_natural_layer_activation.hdf5','r')as f:
      ...
      print(cc)
      if neuro_wise=='True':
        np.save(f'gdrive/MyDrive/V4/{session_name}/synth/{model_type}_synth_neuron_corr.npy',total_synth_corr)
        np.save(f'gdrive/MyDrive/V4/{session_name}/synth/{model_type}_natural_neuron_corr.npy',total_natural_corr)
