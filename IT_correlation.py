...
#   print(synth_image_tensor.shape)
  ...
  with h5py.File(f'{args.neuro_wise}_{model_type}_synth_layer_activation.hdf5','r')as s:
    with h5py.File(f'{args.neuro_wise}_{model_type}_natural_layer_activation.hdf5','r')as f:
      ...
      print(cc)
      if neuro_wise=='True':
        np.save(f'gdrive/MyDrive/IT/{domain_name}/{model_type}_synth_neuron_corr.npy',total_synth_corr)
        np.save(f'gdrive/MyDrive/IT/{domain_name}/{model_type}_natural_neuron_corr.npy',total_natural_corr)
        ...
        with open(f"gdrive/MyDrive/IT/{domain_name}/{model_type}_natural.json", 'w') as f:
          json.dump(natural_json, f)
        with open(f"gdrive/MyDrive/IT/{domain_name}/{model_type}_synth.json", 'w') as f:
        ...
        print(json_object)
        with open(f"gdrive/MyDrive/IT/{domain_name}/{model_type}_natural_mean.json", 'w') as f:
