...
#             clf = Ridge(random_state=seed)
      ...
      print(cc)
      if neuro_wise=='True':
        np.save(f'gdrive/MyDrive/V4/{session_name}/pls_10_{model_type}_synth_neuron_corr.npy',total_synth_corr)
        np.save(f'gdrive/MyDrive/V4/{session_name}/pls_10_{model_type}_natural_neuron_corr.npy',total_natural_corr)
